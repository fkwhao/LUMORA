...
public enum ChatStreamEventType {
    ...
    AGENT_INBOX_ENQUEUED("agent_inbox_enqueued"),
    AGENT_ACTIVATION_STARTED("agent_activation_started"),
    AGENT_ACTIVATION_INTERRUPTED("agent_activation_interrupted"),
    AGENT_REPORTED("agent_reported"),
    AGENT_CHECKPOINTED("agent_checkpointed"),
    AGENT_PEER_MESSAGE_QUEUED("agent_peer_message_queued"),
    AGENT_PEER_MESSAGE_DELIVERED("agent_peer_message_delivered"),
    AGENT_PEER_MESSAGE_CONSUMED("agent_peer_message_consumed"),
