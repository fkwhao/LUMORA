...
globalStyle(".provider-enabled-state", { padding: "5px 9px", color: "var(--muted)", borderRadius: "999px", background: "color-mix(in srgb, var(--ink) 6%, transparent)", fontSize: "9px" });
globalStyle(".provider-enabled-state.ready", { color: "#0d6e3c", background: "rgb(64 201 119 / 22%)" });
