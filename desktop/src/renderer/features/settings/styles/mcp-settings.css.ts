...
globalStyle(".mcp-editor-grid label, .mcp-editor-grid .mcp-field", { display: "grid", minWidth: 0, gap: "7px" });
globalStyle(".mcp-editor-grid label.mcp-field-wide", { gridColumn: "1 / -1" });
globalStyle(".mcp-editor-grid label > span, .mcp-editor-grid .mcp-field > span", { color: "#414750", fontSize: "9px", fontWeight: "650" });
...
globalStyle('[data-slot="select-trigger"].mcp-select-trigger', { display: "flex", width: "100%", minHeight: "38px", height: "38px", alignItems: "center", justifyContent: "space-between", padding: "0 10px", color: "var(--ink)", border: "1px solid var(--line-strong)", borderRadius: "9px", outline: "0", background: "var(--surface-soft)", boxShadow: "none", cursor: "pointer", fontSize: "10px" });
globalStyle('[data-slot="select-trigger"].mcp-select-trigger:hover', { background: "var(--surface)" });
globalStyle('[data-slot="select-trigger"].mcp-select-trigger:focus-visible', { borderColor: "color-mix(in srgb, var(--accent) 46%, var(--line-strong))", boxShadow: "0 0 0 3px color-mix(in srgb, var(--accent) 12%, transparent)" });
globalStyle('[data-slot="select-popover"].mcp-select-popover', { minWidth: "var(--trigger-width)", padding: "5px", border: "1px solid var(--line-strong)", borderRadius: "11px", background: "var(--surface)", boxShadow: "0 18px 48px rgb(47 58 73 / 18%)" });
globalStyle('[data-slot="list-box-item"].mcp-select-option', { minHeight: "34px", padding: "0 30px 0 10px", color: "var(--muted)", borderRadius: "7px", fontSize: "10px" });
globalStyle('[data-slot="list-box-item"].mcp-select-option:hover, [data-slot="list-box-item"].mcp-select-option[data-hovered], [data-slot="list-box-item"].mcp-select-option[data-focused], [data-slot="list-box-item"].mcp-select-option[data-selected]', { color: "var(--ink)", background: "color-mix(in srgb, var(--accent) 10%, transparent)" });
